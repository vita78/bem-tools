...
var Level = exports.Level = INHERIT(/** @lends Level.prototype */{
     ...
     *
     * @param {String|Function|Object} techIdent  Tech identifier or function which return tech object or tech object.
     * @param {Boolean} [force]  Flag to not use tech name resolution.
     * @return {String|Object}  Tech module path or result of techIdent when it is a function,
     * or techIdent if it is an object.
     */
    resolveTech: function(techIdent, force) {
        if (typeof techIdent === 'function') {
            return techIdent();
        }

        if (typeof techIdent === 'object') {
            return techIdent;
        }
    ...
    scanBlock: function(path, block, items) {
        ...
        dirs.forEach(function(dir) {
            ...
            files = [];
            bemUtil.getDirsFilesSync(PATH.join(path, block, dir), null, files);
