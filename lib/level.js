    ...
    getLevelClass = function(path, optional, stack) {
        ...
        try {
            ...
            throw new Error(util.format(
                'level module %s can not be found but required by the level %s%s\n',
                path,
        ...
        var baseLevelPath = level.baseLevelPath ||
            (level.baseLevelName?
            PATH.join(PATH.resolve(__dirname, './levels'), level.baseLevelName):
            null);
